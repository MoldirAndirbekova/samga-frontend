    ...
    <div className="flex">
      <main className="flex-1 p-10 bg-[#FFF8E1] flex text-[#694800]">
        <div>
          ...
          <div className="bg-[#f0d495] p-6 rounded-lg">
            <textarea
              ...
              style={{ resize: "none" }}
            />
            {error && <p className="text-red-600 mt-2 ">⚠️ Feedback is required</p>}
            <Button className="mt-4 bg-[#F9DB63] text-[#694800] px-6 py-3 text-lg font-semibold rounded-lg shadow-md" onClick={handleSubmit}>Submit</Button>
          </div>
        </div>
